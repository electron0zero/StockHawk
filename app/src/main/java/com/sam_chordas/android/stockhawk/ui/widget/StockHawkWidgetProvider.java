...
public class StockHawkWidgetProvider extends AppWidgetProvider {
    ...
    public StockHawkWidgetProvider() {
    ...
    public void onEnabled(Context context) {
        ...
        if (sDataObserver == null) {
            ...
            final ComponentName cn = new ComponentName(context, StockHawkWidgetProvider.class);
    ...
    private RemoteViews buildLayout(Context context, int appWidgetId) {
        ...
        final Intent intent = new Intent(context, StockHawkWidgetRemoteViewService.class);
        intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId);
        intent.setData(Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME)));
        rv = new RemoteViews(context.getPackageName(), R.layout.stock_hawk_widget);
        rv.setRemoteAdapter(R.id.widget_list, intent);

        final Intent onClickIntent = new Intent(context, StockHawkWidgetProvider.class);
        onClickIntent.setAction(StockHawkWidgetProvider.CLICK_ACTION);
