...
public class DetailGraphActivity extends AppCompatActivity {
    ...
    private void downloadStockDetails() {
        ...
        Request request = new Request.Builder()
                .url("http://chartapi.finance.yahoo.com/instrument/1.0/" + companySymbol + "/chartdata;type=quote;range=6m/json")
                .build();
    ...
    private void onDownloadCompleted() {
        DetailGraphActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                isLoaded = true;
